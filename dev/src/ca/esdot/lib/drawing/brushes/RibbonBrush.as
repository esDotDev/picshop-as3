package ca.esdot.lib.drawing.brushes
{
	 ...
	 * 
	 */
	public class RibbonBrush extends AbstractBrush implements IBrush
	{
		//--------------------------------------------------------------------------
		//
		//  Class variables
		...
		private var drawingFPS:uint;
		//--------------------------------------------------------------------------
		//
		//  Initialization
		//
		//--------------------------------------------------------------------------
		public function RibbonBrush(canvas:Sprite,widthVal:int,heightVal:int)
		{
			super(canvas);
			this.drawingFPS = 60; // or 30 
			this.width = widthVal;
			...
			this.timer = new Timer(1000/this.drawingFPS);
		...
		private function handleTimer(e:TimerEvent):void
		{
			...
			for (i = 0; i < this.painters.length; i++)
			{
				...
				this.target.graphics.lineTo(this.painters[i].dx, this.painters[i].dy);
			}
		}
